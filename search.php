...
<aside>
    <div class="sidebar-widget">
        ...
        <form action="search.php" method="GET">
            <input type="search" name="q" placeholder="Escribe aquí..." value="<?php echo htmlspecialchars($query); ?>" required>
    ...
    <div class="sidebar-widget">
        <h4>Acerca de mí</h4>
        <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEj8rP2GgB1h92v_Gbi3p3A_5q7-wS-GqTzH8U2o5J8w/s220/Ana.jpg" alt="Foto de Ana Sampedro" style="width: 100%;">
        <p>Mi nombre es Ana y soy doctora en Biología por la Universidad de Vigo...</p>
        <a href="acerca-de-mi.php">Leer más</a>
    </div>
    <hr>
