...
(function () {
    ...
    function loadFromStorage() {
        try {
            ...
            state.wideLineHeight = localStorage.getItem(STORAGE_KEYS.lineHeight) === '1';
        } catch (e) {
    ...
    function saveToStorage() {
        try {
            ...
            localStorage.setItem(STORAGE_KEYS.lineHeight, state.wideLineHeight ? '1' : '0');
        } catch (e) {
    ...
    function applyToDOM() {
        ...
        // Interlineado amplio
        root.classList.toggle('wide-line-height', state.wideLineHeight);
        // Zoom de fuente
    ...
    function updateButtonStates() {
        ...
        var btnLH = document.getElementById('toggle-line-height');
        if (btnLH) {
            btnLH.setAttribute('aria-pressed', String(state.wideLineHeight));
        }
    }
    ...
    var Prefs = {
        ...
        get: function () {
            return {
                ...
                hc: state.hc,
                zoom: state.zoom,
                wideLineHeight: state.wideLineHeight,
            };
        },
        ...
        set: function (newValues) {
            ...
            if (typeof newValues.wideLineHeight === 'boolean') {
                state.wideLineHeight = newValues.wideLineHeight;
            }
        ...
        toggleLineHeight: function () {
            this.set({ wideLineHeight: !state.wideLineHeight });
        },
        ...
        reset: function () {
            ...
            state.wideLineHeight = DEFAULTS.wideLineHeight;
            saveToStorage();
            applyToDOM();
        },
